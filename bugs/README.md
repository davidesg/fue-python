...
In-repo bug tracker for **fue**.  One Markdown file per bug (`BUG-NNNN-slug.md`); this index is generated by `art-bug index`.
...
| [BUG-0019](BUG-0019-el-puerto-rechaza-un-pre-que-escribe-el-propio-m.md) | fixed | high | inp-reader | El puerto rechaza un .pre que escribe el propio motor: phi2 = -0.0 falla el test 'coef must be negative', que en C es '> 0.0' y pasa | 0.1.16 |
